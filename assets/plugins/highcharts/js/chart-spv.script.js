$(function () {
  ...
  Highcharts.chart("process-CheckerReceiving", {
    chart: {
      type: "column",
      styledMode: true,
    },
  ...
  // chart Base On Level
  Highcharts.chart("level-CheckerReceiving", {
    chart: {
  ...
  // chart Base On Level
  Highcharts.chart("level-Transporter", {
    chart: {
      plotBackgroundColor: null,
      plotBorderWidth: null,
      plotShadow: false,
